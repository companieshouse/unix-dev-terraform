resource "aws_security_group" "oracle_19_build_2" {
...
resource "aws_vpc_security_group_ingress_rule" "oracle_19_build_2_ssh" {
  description       = "Allow SSH connectivity for application deployments"
  security_group_id = aws_security_group.oracle_19_build_2.id
...
resource "aws_vpc_security_group_egress_rule" "oracle_19_build_2_all_out" {
