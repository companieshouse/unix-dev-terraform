resource "aws_security_group" "rhel8_base_build" {
...
resource "aws_vpc_security_group_ingress_rule" "rhel8_base_build_ssh" {
  description       = "Allow SSH connectivity for application deployments"
  security_group_id = aws_security_group.rhel8_base_build.id
...
resource "aws_vpc_security_group_egress_rule" "rhel8_base_build_all_out" {
