resource "aws_security_group" "linux_dev_03" {
...
resource "aws_vpc_security_group_ingress_rule" "linux_dev_03_ssh" {
  description       = "Allow SSH connectivity for application deployments"
  security_group_id = aws_security_group.linux_dev_03.id
...
resource "aws_vpc_security_group_egress_rule" "linux_dev_03_all_out" {
